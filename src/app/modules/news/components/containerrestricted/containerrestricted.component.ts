...
@Component({
  selector: 'news-containerrestricted',
  templateUrl: './containerrestricted.component.html',
  styleUrls: ['./containerrestricted.component.css']
})
export class ContainerrestrictedComponent implements OnInit {
  @Input()
  news:Array<News>;
